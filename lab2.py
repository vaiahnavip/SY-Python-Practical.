...
rice_qty = float(input("enter the quantity of the rice(in kg):"))
rice_price_per_kg = 50
rice_total = rice_qty = rice_price_per_kg


sugar_qty = float(input("enter the quantity of the sugar(in kg):"))
sugar_price_per_kg = 40
sugar_total = sugar_qty = sugar_price_per_kg


oil_qty = float(input("enter the quantity of the oil(in litres):"))
